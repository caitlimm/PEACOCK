### This pipeline explains how to generate the dataset ascribing machine learning features of interest (to PEACOCK) to all cis enhancer-gene links involving PEREGRINE enhancers and PANTHER genes. 
